...
impl Drop for SessionKeys {
    fn drop(&mut self) {
        // X25519Secret and SigningKey implement ZeroizeOnDrop natively.
        // RSA keys: we rely on rsa crate's drop behavior + explicit zeroize.
        // Ed25519 SigningKey: implements ZeroizeOnDrop.
        // This Drop impl is a safety net.
    }
}
